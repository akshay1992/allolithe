...
TEST_F( AtlasTest, PiecewiseLinearScaler) 
{
	al::PiecewiseLinearScaler scaler;
	...
	{
		EXPECT_FLOAT_EQ( scaler.getMul(inputs[i]), outputs[i]);
	}
}
...
TEST_F( AtlasTest, sphericalAtlas_getUVD)
{
	al::SphericalAtlas atlas;
	// TODO
}